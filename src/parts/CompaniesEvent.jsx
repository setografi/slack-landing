...
export default function CompaniesEvent() {
  return (
    <>
      <section className="relative bg-WhiteBack h-full md:h-[370px] border-y-2 border-BlackTextTwo">
        <div className="image-semicircle absolute top-8 left-12 md:left-[8rem] lg:left-[16rem] xl:left-[27rem]">
        ...
        <div className="flex flex-col justify-center items-center text-center py-[70px] mx-6 lg:mx-0">
          <h1 className="font-syne font-bold text-xl md:text-3xl xl:text-[2.125rem] text-BlackTextTwo">
            ...
            <span className="font-extrabold text-xl md:text-2xl leading-8 lg:leading-10">
              ALL OVER THE WORLD
            </span>
          </h1>
        ...
        <div className="image-line absolute bottom-[51.5rem] md:bottom-52 right-[4.9rem] md:right-[9.7rem] lg:right-[18rem] xl:right-[31rem]">
